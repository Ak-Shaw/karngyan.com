...
export default {
  ...
  data() {
    return {
      ...
      content: `Hey there! 👋 <br /><br />I'm Ayush 🤗 <br/><br/>Feel free to have a look around so that you can get to know me even without knowing me! 👀<br /><br />You know what I mean right? 😗`,
    }
  }
}
</script>
